...
export default { isValid,isValidAddress, isValidObjectId,isValidBody, isValidEmail, isValidNumber, isValidName, isValidPincode,isValidInput,isValidPrice ,isValidPassword,isValidImageType,isValidJson,isEmptyObject};